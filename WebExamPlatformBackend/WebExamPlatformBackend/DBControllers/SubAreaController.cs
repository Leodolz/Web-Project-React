...
namespace WebExamPlatformBackend.DBControllers
{
    ...
    {
        private SubAreaRepository subAreaRepository = new SubAreaRepository(new ExamPlatformDBContext());
        private SubAreaAssignRepository subAreaAssignRepository = new SubAreaAssignRepository(new ExamPlatformDBContext());
